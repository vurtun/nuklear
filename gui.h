 ...
 * ===============================================================
 */
GUI_API struct gui_rect gui_get_null_rect(void);
GUI_API gui_size gui_utf_decode(const gui_char*, gui_long*, gui_size);
GUI_API gui_size gui_utf_encode(gui_long, gui_char*, gui_size);
